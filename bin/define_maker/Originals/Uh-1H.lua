...
{combos = {{key = 'I'}}, down = device_commands.Button_17, cockpit_device_id = devices.ENGINE_INTERFACE, value_down = 0.0, name = _('De-Ice On/Off'), category = _('Pedestal')},
...
{combos = {{key = 'W', reformers = {'RCtrl'}}}, down = device_commands.Button_22, cockpit_device_id = devices.ENGINE_INTERFACE, value_down = 1.0, name = _('Low RPM Warning'), category = _('Pedestal')},
...
-- Flexible sight
{combos = {{key = 'M'}}, down = device_commands.Button_5, cockpit_device_id = devices.FLEX_SIGHT, value_down = 0.0, name = _('Flexible Sight On/Off'), category = _('Flexible Sight')},
...
{combos = {{key = 'M', reformers = {'RCtrl'}}}, down = device_commands.Button_7, cockpit_device_id = devices.PILOT_SIGHT, value_down = 1.0, name = _('Pilot Sight On/Off'), category = _('Pilot Sight')},
...
{combos = {{key = 'J'}}, down = device_commands.Button_23, up = device_commands.Button_23, cockpit_device_id = devices.WEAPON_SYS, value_down = 1.0, value_up = 0.0, name = _('Jettison'), category = _('Armament System')},
{combos = {{key = 'J', reformers = {'LAlt'}}}, down = device_commands.Button_25, cockpit_device_id = devices.WEAPON_SYS, value_down = 0.0, name = _('Jettison Cover'), category = _('Armament System')},
{combos = {{key = 'R', reformers = {'LCtrl'}}}, down = device_commands.Button_12, up = device_commands.Button_12, cockpit_device_id = devices.WEAPON_SYS, value_down = 1.0, value_up = 0.0, name = _('Rocket reset'), category = _('Armament System')},
...
{combos = {{key = 'H', reformers = {'LCtrl','LShift'}}}, down = device_commands.Button_27, cockpit_device_id = devices.WEAPON_SYS, value_down = 1.0, name = _('Weapon Hints On/Off'), category = _('Cheat')},
...
{combos = {{key = 'T', reformers = {'RWin'}}}	, down = device_commands.Button_28,	cockpit_device_id = devices.ENGINE_INTERFACE, value_down = 1.0,	name = _('Throttle Stop'), category = _('Ins Collective Stick')},
...
{combos = {{key = ',', reformers = {'RCtrl'}}}, down = device_commands.Button_12, cockpit_device_id = devices.NAVLIGHT_SYSTEM, value_down = 1.0, name = _('Landing light On/Off'), category = _('Ins Collective Stick')},
...
{combos = {{key = 'L', reformers = {'RShift'}}}, 	down = device_commands.Button_14, cockpit_device_id = devices.NAVLIGHT_SYSTEM, value_down = 1.0, name = _('Anti Collision Light On/Off'), category = _('Ins Overhead panel')},
...
{combos = {{key = 'Q', reformers = {'LShift'}}},down = device_commands.Button_10, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1.0, name = _('Main generator ON/OFF'), category = _('Ins Overhead panel')},
...
{combos = {{key = 'P', reformers = {'LShift'}}},down = device_commands.Button_9, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1.0, name = _('Battery ON/OFF'), category = _('Ins Overhead panel')},
...
{combos = {{key = 'R', reformers = {'LShift'}}},down = device_commands.Button_7, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 0.1, name = _('Voltmeter AC, AC phase'), category = _('Ins Overhead panel')},
...
{combos = {{key = 'P', reformers = {'RAlt'}}},down = device_commands.Button_17, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 0.0, name = _('Pitot Heater'), category = _('Ins Overhead panel')},
...
{combos = {{key = 'U', reformers = {'LAlt'}}}, down = device_commands.Button_6, cockpit_device_id = devices.HYDRO_SYS_INTERFACE, value_down = 1.0,name = _('Force Trim System On/Off'), category = _('Systems')}, 
{combos = {{key = 'I', reformers = {'LAlt'}}}, down = device_commands.Button_5, cockpit_device_id = devices.HYDRO_SYS_INTERFACE, value_down = 1.0,name = _('Hydraulic control On/Off'), category = _('Systems')}, 
...
--AN/ARC-131
{combos = {{key = '9', reformers = {'LCtrl','LShift'}}}, down = device_commands.Button_6, cockpit_device_id = devices.VHF_ARC_134, value_down = 1, name = _('VHF AM Radio Power ON/OFF'), 	category = _("VHF AM Radio Control panel")},
...
{combos = {{key = 'Q', reformers = {'LCtrl','LShift'}}}, down = device_commands.Button_10,	cockpit_device_id = devices.UHF_ARC_51, value_down = 1.0, 		name = _('UHF Radio Squelch On/Off'), 		category = _("UHF Radio Control panel")},
...
{combos = {{key = 'Y', reformers = {'LCtrl','LShift'}}},down = device_commands.Button_14,	cockpit_device_id = devices.UHF_ARC_51, value_down = -1.0,name = _('UHF Radio 50kHz Decrease'), 	category = _("UHF Radio Control panel")},
...
{combos = {{key = 'R', reformers = {'RShift'}}}, down = device_commands.Button_8, cockpit_device_id = devices.RADAR_ALTIMETER, value_down = 1.0,  name = _('Radar Altimeter Power'), category = _('Circuit breaker panel')},
...
{down = device_commands.Button_12, cockpit_device_id = devices.XM_130, value_down = 0.0, name = _('Ripple Fire'), category = _('Pedestal')},
...
{down = device_commands.Button_14, cockpit_device_id = devices.XM_130, value_down = 0.0, name = _('MAN/PGRM Mode'), category = _('Pedestal')},
{combos = {{key = 'C', reformers = {'LCtrl'}}}, down = device_commands.Button_6, up = device_commands.Button_6, cockpit_device_id = devices.XM_130, value_down = 1.0, value_up = 0.0, name = _('Flare Dispense'), category = _('Pedestal')},
{down = device_commands.Button_10, up = device_commands.Button_10, cockpit_device_id = devices.XM_130, value_down = 1.0, value_up = 0.0, name = _('Armed lamp Test'), category = _('Pedestal')},
