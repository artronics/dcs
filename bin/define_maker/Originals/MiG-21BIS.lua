...
--NPPsetCourse
{combos={{key='X',reformers={'LAlt'}}},down=device_commands.NPPsetCourse,up=device_commands.NPPsetCourse,cockpit_device_id=devices.KSI,value_pressed=1.0,value_up=0.0,name='NPP Course set +',category='Avionics'},
{combos={{key='X',reformers={'LAlt','LWin'}}},down=device_commands.NPPsetCourse,up=device_commands.NPPsetCourse,cockpit_device_id=devices.KSI,value_pressed=-1.0,value_up=0.0,name='NPP Course set -',category='Avionics'},
...
-- {combos={{key='Num+'}},pressed=device_commands.ThrottleInc,up=device_commands.ThrottleInc,cockpit_device_id=devices.CONTROL_SYSTEM,value_pressed=1.0,value_up=0.0,name='Throttle Up',category='Flight Controls'},
-- {combos={{key='Num-'}},pressed=device_commands.ThrottleDec,up=device_commands.ThrottleDec,cockpit_device_id=devices.CONTROL_SYSTEM,value_pressed=1.0,value_up=0.0,name='Throttle Down',category='Flight Controls'},
...
-- {combos={{key='Z'}},pressed=device_commands.RudLeft,up=device_commands.RudLeft,cockpit_device_id=devices.CONTROL_SYSTEM,value_pressed=1.0,value_up=0.0,name='Rudder Left',category='Flight Controls'},
-- {combos={{key='X'}},pressed=device_commands.RudRight,up=device_commands.RudRight,cockpit_device_id=devices.CONTROL_SYSTEM,value_pressed=1.0,value_up=0.0,name='Rudder Right',category='Flight Controls'},
...
{combos={{key='C',reformers={'LAlt'}}},down=device_commands.CanopyHermetHandle,cockpit_device_id=devices.CANOPY,value_down=1.0,name='Canopy Pressurized',category='Life support'},--/N/ hermetization, compression
{combos={{key='C',reformers={'LAlt','LCtrl'}}},down=device_commands.CanopyHermetHandle,cockpit_device_id=devices.CANOPY,value_down=0.0,name='Canopy Unpressurized',category='Life support'},--/N/ dehermetization, decompression
...
-- View 
{combos={{key='Num4'}},pressed=iCommandViewLeftSlow,up=iCommandViewStopSlow,name='View Left slow',category='Views'},
{combos={{key='Num6'}},pressed=iCommandViewRightSlow,up=iCommandViewStopSlow,name='View Right slow',category='Views'},
{combos={{key='Num8'}},pressed=iCommandViewUpSlow,up=iCommandViewStopSlow,name='View Up slow',category='Views'},
{combos={{key='Num2'}},pressed=iCommandViewDownSlow,up=iCommandViewStopSlow,name='View Down slow',category='Views'},
{combos={{key='Num9'}},pressed=iCommandViewUpRightSlow,up=iCommandViewStopSlow,name='View Up Right slow',category='Views'},
{combos={{key='Num3'}},pressed=iCommandViewDownRightSlow,up=iCommandViewStopSlow,name='View Down Right slow',category='Views'},
{combos={{key='Num1'}},pressed=iCommandViewDownLeftSlow,up=iCommandViewStopSlow,name='View Down Left slow',category='Views'},
{combos={{key='Num7'}},pressed=iCommandViewUpLeftSlow,up=iCommandViewStopSlow,name='View Up Left slow',category='Views'},
{combos={{key='Num5'}},pressed=iCommandViewCenter,name='View Center',category='Views'},
...
{combos={{key='Space'}},down=device_commands.GunFireBtn,up=device_commands.GunFireBtn,cockpit_device_id=devices.WEAPON_CONTROL,value_down=1.0,value_up=0.0,name='Fire Gun',category='Weapons'},

{combos={{key='Space',reformers={'LAlt'}}},down=device_commands.PuskBtn,up=device_commands.PuskBtn,cockpit_device_id=devices.WEAPON_CONTROL,value_down=1.0,value_up=0.0,name='Weapon Release',category='Weapons'},
